...
*/
	public void updateSevenXLS(String department,String branch,List<Project> listProject,int year, int month,
		...
		try {
			File file;
				file= new File("D:\\"+department+"\\"+department+"\\"+year+"\\"+month+"月"+filenameString); 
			...
			if (branch==null) {
				strnameString2="d:/"+department+"/"+department+"/"+year+"/"+month+"月"+filenameString+"/"+"集計データ"+department+year+"年"+month+"月"+"_"+endyear+"年"+endmonth+"月"+".xls";//由模板生成的最终文件所在地址
			}
			else {
				strnameString2="d:/"+department+"/"+department+"/"+year+"/"+month+"月"+filenameString+"/"+"集計データ"+department+branch+year+"年"+month+"月"+"_"+endyear+"年"+endmonth+"月"+".xls";//由模板生成的最终文件所在地址
			}
