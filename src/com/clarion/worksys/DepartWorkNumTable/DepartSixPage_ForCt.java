 ...
 */
public class DepartSixPage_ForCt {
/**
 * 生成部门/课别第六页(PJ毎のプロセス工数)信息_ForCt
 * @param user   出力者
...
*/
	public void updateSixXLS_ForCt(String user, String department,String branch,List<Project> listProject,int year, int month,
...
/*			Label label0_7 = new Label(1, rownum + listDepartSencouTasks.size() * listDepartSencouProjects.size() + 3, "PJ No.",formato3);
			sheetSix.addCell(label0_7);
			Label label0_8 = new Label(2, rownum + listDepartSencouTasks.size() * listDepartSencouProjects.size() + 3, "PJ名（人月）",formato3);
			sheetSix.addCell(label0_8);
			Label label0_9 = new Label(3, rownum + listDepartSencouTasks.size() * listDepartSencouProjects.size() + 3, "プロセス名",formato3);
