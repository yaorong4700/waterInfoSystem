 ...
 */
public class DepartThirdPage {
/**
 * 生成部门或者课别第三页（RFI和RFQ）的数据
 ...
 */
	public void updateThirdXLS(String department,String branch,List<Project> listProject,int year, int month,
		...
		try {
			...
			if (branch==null) {
				...
				Label labelbLabelfg = new Label(1, 1, department+branch,formatgr);
				sheetThree.addCell(labelbLabelfg);
			}
