...
<body>
  <form id="xlsForm" method="post" enctype="multipart/form-data">
    <div class="ehdel_upload_show">
      <!-- <p align="left" style="padding-left:10px;"><label id="staffUpload_string_title_1">如果没有文件模板文件，请下载</label> <a id="staffUpload_string_title_2" target="_blank" href="../resource/Staff_Template_CXEE.xls">Excel模板文件。</a></p> -->
      <p align="left" style="padding-left:10px; padding-bottom:0px; border-bottom:0px; margin-bottom:0px"><label id="staffUpload_string_title_3">选择上传文件：</label></p>
