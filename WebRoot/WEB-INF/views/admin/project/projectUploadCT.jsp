        ...
        success:function (data){
            ...
            if(obj.code == "S"){
                ...
                for(var i = 0; i< obj.result.length; i++){
                    if (i == 0){
                         $("#gridTableCT").append('<tr align="center" bgcolor="#FFFFFF"><td width="60" bgcolor="#FFFFFF">'+staffUpload_string_msg_4+'</td><td width="100" bgcolor="#FFFFFF">'+staffUpload_string_msg_5+'</td><td bgcolor="#FFFFFF">'+staffUpload_string_msg_6+'</td></tr>');
                    }
                    $("#gridTableCT").append('<tr align="center" bgcolor="#FFFFFF" ><td>'+obj.result[i].errNo+'</td><td  bgcolor="#FFFFFF">'+obj.result[i].errItem+'</td><td  bgcolor="#FFFFFF">'+ obj.result[i].errContent +"</td></tr>");
                }
            }
        },
        error:function(data){
...
<body>
	<form id="xlsForm" method="post" enctype="multipart/form-data">
		<div class="ehdel_upload_show">
			<p align="left" style="padding-left: 10px;">
				<label id="staffUpload_string_title_1">フォーマットがない場合、ここからダウンロードしてください。</label> <a
					id="staffUpload_string_title_2" target="_blank"
					href="../resource/Project_Template_CT.xls">フォーマット</a>
			</p>
			<p align="left"
				style="padding-left: 10px; padding-bottom: 0px; border-bottom: 0px; margin-bottom: 0px">
				<label id="staffUpload_string_title_3">アップロードするファイルを指定してください：</label>
			</p>
			<!-- <input id="ehdel_upload_text" type="text" name="txt"
				style="width: 250px;" /> -->
			<!-- <input id="ehdel_upload_btn"
	...
	<div>
		<table id="gridTableCT" border="0" width="400" cellspacing="1"
