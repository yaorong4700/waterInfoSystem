...
<body>
	<script type="text/javascript">
		...
		if(msg=="success" || msg==""){
			...
			parent.success();
		}else if(msg=="failedOnlyDepartment"){
			parent.failedOnlyDepartment();
		}else if(msg=="failedManyBranchTeam"){
			parent.failedManyBranchTeam();
		}else if(msg=="failedNoDepartment"){
			parent.failedNoDepartment();
		}else if(msg=="failedDepartmentExist"){
			parent.failedDepartmentExist();
		}else if(msg=="failed"){
			parent.failed();
		}
	</script>
