...
<body>
  <form id="xlsForm" method="post" enctype="multipart/form-data">
    <div class="ehdel_upload_show">
      <p align="left" style="padding-left:10px;"><label id="staffUpload_string_title_1">如果没有文件模板文件，请下载</label> <a id="staffUpload_string_title_2" target="_blank" href="../resource/Staff_Template_CT.xls">Excel模板文件。</a></p>
